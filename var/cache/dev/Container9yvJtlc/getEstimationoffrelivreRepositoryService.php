 ...
 */
class getEstimationoffrelivreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EstimationoffrelivreRepository' shared autowired service.
     *
     * @return \App\Repository\EstimationoffrelivreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EstimationoffrelivreRepository.php';

        return $container->privates['App\\Repository\\EstimationoffrelivreRepository'] = new \App\Repository\EstimationoffrelivreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
