...
class __TwigTemplate_136e7bf2c60681b1f28b475445c2e60b extends Template
{
    private $source;
    private $macros = [];
   ...
   <table>
    ...
    <td>";
        // line 4
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 4, $this->source); })()), "date", [], "any", false, false, false, 4), 'label', ["label" => "Date"]);
        echo "</td>
    
    <td>";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), "date", [], "any", false, false, false, 6), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "</td>
    ...
    <button class=\"btn btn-primary\">";
        // line 22
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 22, $this->source); })()), "Add")) : ("Add")), "html", null, true);
        echo "</button>
    </div>
";
        // line 24
...
";
    ...
    {
        return array (  90 => 24,  85 => 22,  76 => 16,  71 => 14,  66 => 12,  59 => 8,  54 => 6,  49 => 4,  43 => 1,);
    }
   ...
   <table>
    ...
    <td>{{form_widget(form.date,{ 'attr': {'class': 'form-control'} })}}</td>
...
{{ form_end(form) }}
", "commentaire/_form.html.twig", "C:\\Users\\amirb\\OneDrive\\Bureau\\web\\beebly-backup-2\\templates\\commentaire\\_form.html.twig");
    }
}
