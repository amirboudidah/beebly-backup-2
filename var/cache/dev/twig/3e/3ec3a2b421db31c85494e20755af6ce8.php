    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["ticket"]) || array_key_exists("ticket", $context) ? $context["ticket"] : (function () { throw new RuntimeError('Variable "ticket" does not exist.', 20, $this->source); })()), "type", [], "any", false, false, false, 20), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>libelle evenement</th>
                <td>";
        // line 24
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["ticket"]) || array_key_exists("ticket", $context) ? $context["ticket"] : (function () { throw new RuntimeError('Variable "ticket" does not exist.', 24, $this->source); })()), "idEvenement", [], "any", false, false, false, 24), "libelle", [], "any", false, false, false, 24), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>libelle evenement</th>
                <td>{{ ticket.idEvenement.libelle }}</td>
            </tr>
        </tbody>
    </table>

    <a href=\"{{ path('app_ticket_index') }}\"><button class=\"btn btn-primary\"> back to list </button></a>

    <a href=\"{{ path('app_ticket_edit', {'id': ticket.id}) }}\"><button class=\"btn btn-warning\"> Edit </button></a>

    {{ include('ticket/_delete_form.html.twig') }}
{% endblock %}
", "ticket/show.html.twig", "C:\\Users\\amirb\\OneDrive\\Bureau\\web\\beebly-backup-2\\templates\\ticket\\show.html.twig");
    }
}
