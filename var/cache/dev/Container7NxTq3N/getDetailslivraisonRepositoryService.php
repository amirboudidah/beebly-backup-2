 ...
 */
class getDetailslivraisonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetailslivraisonRepository' shared autowired service.
     *
     * @return \App\Repository\DetailslivraisonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetailslivraisonRepository.php';

        return $container->privates['App\\Repository\\DetailslivraisonRepository'] = new \App\Repository\DetailslivraisonRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
